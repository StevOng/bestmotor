# Generated by Django 5.0.7 on 2025-05-04 06:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('harga_satuan1', models.DecimalField(decimal_places=2, max_digits=19)),
                ('harga_satuan2', models.DecimalField(decimal_places=2, max_digits=19)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('lunas', 'Lunas'), ('belum lunas', 'Belum Lunas'), ('jatuh tempo', 'Jatuh Tempo')], default='belum lunas', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.DecimalField(decimal_places=2, max_digits=19)),
                ('status', models.CharField(choices=[('belum lunas', 'Belum Lunas'), ('lunas', 'Lunas')], default='belum lunas', max_length=30)),
                ('terakhir_edit', models.DateTimeField(auto_now=True)),
